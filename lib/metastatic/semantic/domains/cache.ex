defmodule Metastatic.Semantic.Domains.Cache do
  ...
  defmodule R do
    ...
    def elixir_cachex_patterns,
      do: [
        ...
        {"Cachex.incr!",
         %{operation: :increment, framework: :cachex, extract_target: :first_arg}},
        {"Cachex.decr", %{operation: :decrement, framework: :cachex, extract_target: :first_arg}},
        {"Cachex.decr!",
         %{operation: :decrement, framework: :cachex, extract_target: :first_arg}},
    ...
    def elixir_nebulex_patterns,
      do: [
        ...
        {"*.delete_all!", %{operation: :clear, framework: :nebulex, extract_target: :none}},
        {"*.get_and_update",
         %{operation: :fetch, framework: :nebulex, extract_target: :first_arg}},
        {"*.get_and_update!",
         %{operation: :fetch, framework: :nebulex, extract_target: :first_arg}},
    ...
    def elixir_ets_patterns,
      do: [
        ...
        {":ets.update_counter",
         %{operation: :increment, framework: :ets, extract_target: :first_arg}}
      ]

    # ----- Python/redis-py Patterns -----

    def python_redis_patterns,
      do: [
        ...
        {"redis.incr",
         %{operation: :increment, framework: :redis_py, extract_target: :first_arg}},
        {"redis.incrby",
         %{operation: :increment, framework: :redis_py, extract_target: :first_arg}},
        {"redis.decr",
         %{operation: :decrement, framework: :redis_py, extract_target: :first_arg}},
        {"redis.decrby",
         %{operation: :decrement, framework: :redis_py, extract_target: :first_arg}},
    ...
    def python_django_cache_patterns,
      do: [
        ...
        {"cache.delete",
         %{operation: :delete, framework: :django_cache, extract_target: :first_arg}},
        ...
        {"cache.touch",
         %{operation: :expire, framework: :django_cache, extract_target: :first_arg}},
        {"cache.has_key",
         %{operation: :exists, framework: :django_cache, extract_target: :first_arg}},
        {"caches[*].get",
         %{operation: :get, framework: :django_cache, extract_target: :first_arg}},
        {"caches[*].set",
         %{operation: :set, framework: :django_cache, extract_target: :first_arg}}
      ]

    # ----- Python/Flask-Caching Patterns -----

    def python_flask_cache_patterns,
      do: [
        ...
        {"cache.delete",
         %{operation: :delete, framework: :flask_cache, extract_target: :first_arg}},
    ...
    def ruby_rails_cache_patterns,
      do: [
        {"Rails.cache.read",
         %{operation: :get, framework: :rails_cache, extract_target: :first_arg}},
        {"Rails.cache.write",
        ...
        {"Rails.cache.clear",
         %{operation: :clear, framework: :rails_cache, extract_target: :none}},
        {"Rails.cache.exist?",
    ...
    def ruby_redis_patterns,
      do: [
        ...
        {~r/redis\.del$/,
         %{operation: :delete, framework: :redis_rb, extract_target: :first_arg}},
        ...
        {~r/redis\.expire$/,
         %{operation: :expire, framework: :redis_rb, extract_target: :first_arg}},
        ...
        {~r/redis\.decr$/,
         %{operation: :decrement, framework: :redis_rb, extract_target: :first_arg}}
      ]

    # ----- JavaScript/node-cache Patterns -----

    def javascript_nodecache_patterns,
      do: [
    ...
    def javascript_ioredis_patterns,
      do: [
        ...
        {"redis.incrby",
         %{operation: :increment, framework: :ioredis, extract_target: :first_arg}},
        {"redis.decr", %{operation: :decrement, framework: :ioredis, extract_target: :first_arg}},
        {"redis.decrby",
         %{operation: :decrement, framework: :ioredis, extract_target: :first_arg}},
  ...
  def register_all do
    ...
    Patterns.register(
      :cache,
      :elixir,
      R.elixir_cachex_patterns() ++
        R.elixir_concache_patterns() ++ R.elixir_nebulex_patterns() ++ R.elixir_ets_patterns()
    )
    ...
    Patterns.register(
      :cache,
      :python,
      R.python_redis_patterns() ++
        R.python_django_cache_patterns() ++ R.python_flask_cache_patterns()
    )
    ...
    Patterns.register(
      :cache,
      :ruby,
      R.ruby_rails_cache_patterns() ++ R.ruby_dalli_patterns() ++ R.ruby_redis_patterns()
    )
    ...
    Patterns.register(
      :cache,
      :javascript,
      R.javascript_nodecache_patterns() ++ R.javascript_ioredis_patterns()
    )

defmodule Metastatic.Semantic.Domains.Http do
  ...
  defmodule R do
    ...
    def elixir_httpoison_patterns,
      do: [
        {"HTTPoison.get", %{operation: :get, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.get!", %{operation: :get, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.post",
         %{operation: :post, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.post!",
         %{operation: :post, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.put", %{operation: :put, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.put!", %{operation: :put, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.patch",
         %{operation: :patch, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.patch!",
         %{operation: :patch, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.delete",
        ...
        {"HTTPoison.delete!",
         %{operation: :delete, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.head",
         %{operation: :head, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.head!",
         %{operation: :head, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.options",
        ...
        {"HTTPoison.options!",
         %{operation: :options, framework: :httpoison, extract_target: :first_arg}},
        {"HTTPoison.request",
         %{operation: :request, framework: :httpoison, extract_target: :none}},
        {"HTTPoison.request!",
         %{operation: :request, framework: :httpoison, extract_target: :none}}
      ]
    ...
    def python_requests_patterns,
      do: [
        ...
        {"requests.patch",
         %{operation: :patch, framework: :requests, extract_target: :first_arg}},
        {"requests.delete",
         %{operation: :delete, framework: :requests, extract_target: :first_arg}},
    ...
    def python_aiohttp_patterns,
      do: [
        ...
        {"aiohttp.ClientSession",
         %{operation: :request, framework: :aiohttp, extract_target: :none}}
      ]

    # ----- Ruby/Net::HTTP Patterns -----

    def ruby_nethttp_patterns,
      do: [
        ...
        {"Net::HTTP.post_form",
         %{operation: :post, framework: :nethttp, extract_target: :first_arg}},
    ...
    def ruby_httparty_patterns,
      do: [
        ...
        {"HTTParty.patch",
         %{operation: :patch, framework: :httparty, extract_target: :first_arg}},
        {"HTTParty.delete",
         %{operation: :delete, framework: :httparty, extract_target: :first_arg}},
        {"HTTParty.head", %{operation: :head, framework: :httparty, extract_target: :first_arg}},
        {"HTTParty.options",
         %{operation: :options, framework: :httparty, extract_target: :first_arg}}
      ]

    # ----- Ruby/Faraday Patterns -----

    def ruby_faraday_patterns,
      do: [
        ...
        {"Faraday.delete",
         %{operation: :delete, framework: :faraday, extract_target: :first_arg}},
        {"Faraday.head", %{operation: :head, framework: :faraday, extract_target: :first_arg}},
        {"Faraday.options",
         %{operation: :options, framework: :faraday, extract_target: :first_arg}},
    ...
    def ruby_restclient_patterns,
      do: [
        {"RestClient.get",
         %{operation: :get, framework: :restclient, extract_target: :first_arg}},
        {"RestClient.post",
         %{operation: :post, framework: :restclient, extract_target: :first_arg}},
        {"RestClient.put",
         %{operation: :put, framework: :restclient, extract_target: :first_arg}},
        {"RestClient.patch",
        ...
        {"RestClient.head",
         %{operation: :head, framework: :restclient, extract_target: :first_arg}},
        {"RestClient.options",
    ...
    def javascript_fetch_patterns,
      do: [
        ...
        {"globalThis.fetch",
         %{operation: :request, framework: :fetch, extract_target: :first_arg}}
      ]

    # ----- JavaScript/axios Patterns -----

    def javascript_axios_patterns,
      do: [
    ...
    def javascript_superagent_patterns,
      do: [
        {"superagent.get",
         %{operation: :get, framework: :superagent, extract_target: :first_arg}},
        {"superagent.post",
         %{operation: :post, framework: :superagent, extract_target: :first_arg}},
        {"superagent.put",
         %{operation: :put, framework: :superagent, extract_target: :first_arg}},
        {"superagent.patch",
        ...
        {"superagent.head",
         %{operation: :head, framework: :superagent, extract_target: :first_arg}},
  ...
  def register_all do
    ...
    Patterns.register(
      :http,
      :elixir,
      R.elixir_httpoison_patterns() ++
        R.elixir_req_patterns() ++ R.elixir_tesla_patterns() ++ R.elixir_finch_patterns()
    )
    ...
    Patterns.register(
      :http,
      :python,
      R.python_requests_patterns() ++ R.python_httpx_patterns() ++ R.python_aiohttp_patterns()
    )
    ...
    Patterns.register(
      :http,
      :ruby,
      R.ruby_nethttp_patterns() ++
        R.ruby_httparty_patterns() ++
        R.ruby_faraday_patterns() ++ R.ruby_restclient_patterns()
    )
    ...
    Patterns.register(
      :http,
      :javascript,
      R.javascript_fetch_patterns() ++
        R.javascript_axios_patterns() ++
        R.javascript_got_patterns() ++ R.javascript_superagent_patterns()
    )
